<template>
	<div :style='{"width":"100%","padding":"20px 16%","margin":"10px auto","position":"relative","background":"#fff"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 35px","margin":"00px auto","alignItems":"flex-start","color":"#3F3F3F","textAlign":"left","flexDirection":"column","display":"flex","justifyContent":"flex-start","background":"url(http://codegen.caihongy.cn/20241209/6e7acbea644a43d485ad6dc6016a9f1e.png) 100% 100%/100% 100%","width":"100%","lineHeight":"100px","fontSize":"34px","fontWeight":"bold","height":"143px"}'>我的收藏</div>
		...
		<el-pagination
			...
			:total="total"
			:style='{"padding":"0","margin":"10px auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","width":"100%","fontWeight":"500","order":"21"}'
