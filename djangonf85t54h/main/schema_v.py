...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderhf6v154d && scrapy crawl "+tableName+"Spider -a databaseName=djangonf85t54h"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=djangonf85t54h"
        os.system(cmd)
